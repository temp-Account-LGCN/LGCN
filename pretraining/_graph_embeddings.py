...
if GRAPH_CONV == '1d':
    ...
    I = sp.sparse.lil_matrix(np.eye(user_number + item_number, user_number + item_number))
    ...
    I_user = sp.sparse.lil_matrix(np.eye(user_number, user_number))
    A_item = sp.sparse.lil_matrix((item_number, item_number))
    D_item = sp.sparse.lil_matrix((item_number, item_number))
    I_item = sp.sparse.lil_matrix(np.eye(item_number, item_number))
