...
IF_WEIGHTED = 0                     # 0 for uniform weighted, 1 for weighted by the 1/popularity.
Dataset = ['Amazon', 'Movielens'][DATASET]
ifWeighted = [False, True][IF_WEIGHTED]
tolerant = 0.1 ** 5
epsilon = 0.1 ** 10
...
I_i = sp.sparse.lil_matrix(np.eye(item_number, item_number))
